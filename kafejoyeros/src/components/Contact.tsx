...
export default function Contact({
  title = "Contáctanos",
  subtitle = "Estamos aquí para ayudarte a crear la joya perfecta",
  contactInfo = {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-bold font-serif text-gray-900 mb-6">Envíanos un Mensaje</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full btn-luxury text-white py-4 rounded-lg font-semibold transition-all duration-300 shadow-luxury hover:shadow-luxury-hover disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold font-serif text-gray-900 mb-6">Información de Contacto</h3>
              
              <div className="space-y-6">
                {/* Address */}
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg flex items-center justify-center">
            ...
            {contactInfo.whatsapp && (
              <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white">
                ...
                <a
                  ...
                  className="inline-flex items-center bg-white text-green-600 px-6 py-3 rounded-full font-semibold hover:bg-green-50 transition-all duration-300"
                >
