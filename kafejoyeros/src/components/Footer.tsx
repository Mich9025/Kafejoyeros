...
export default function Footer({
  ...
  socialLinks = {
    facebook: "https://facebook.com/kafejoyeros",
    instagram: "https://instagram.com/kafejoyeros",
    twitter: "https://twitter.com/kafejoyeros",
  ...
  const services = [
    { name: 'Diseño Personalizado', href: '/servicios#diseno' },
    { name: 'Reparación', href: '/servicios#reparacion' },
    { name: 'Engastado', href: '/servicios#engastado' },
    { name: 'Grabado', href: '/servicios#grabado' },
    { name: 'Redimensionado', href: '/servicios#redimensionado' },
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold font-serif">{companyName}</span>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              {socialLinks.instagram && (
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.596-3.205-1.533l1.714-1.714c.39.39.927.633 1.491.633.564 0 1.101-.243 1.491-.633l1.714 1.714c-.757.937-1.908 1.533-3.205 1.533zm7.098 0c-1.297 0-2.448-.596-3.205-1.533l1.714-1.714c.39.39.927.633 1.491.633.564 0 1.101-.243 1.491-.633l1.714 1.714c-.757.937-1.908 1.533-3.205 1.533z"/>
                  </svg>
                </a>
              )}
              {socialLinks.twitter && (
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold font-serif mb-6">Servicios</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            {/* Newsletter Signup */}
            <div className="mt-6">
              <h4 className="text-sm font-semibold font-serif mb-3">Newsletter</h4>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Tu email"
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:border-gray-400 text-sm"
                />
                <button className="px-4 py-2 btn-luxury text-white rounded-r-lg transition-all duration-300">
